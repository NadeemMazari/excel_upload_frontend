...
import { Upload, ChevronLeft, ChevronRight, AlertCircle, Loader2 } from "lucide-react"
...
//   }
  ...
  const totalPages = originalData.totalPages || Math.ceil(data.length / pageSize)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-800 mb-2">Excel Data Manager</h1>
            <p className="text-slate-600">Upload and manage your Excel files with ease</p>
          </div>
              ...
              <div className="flex items-center justify-center space-x-3">
                {isLoading ? (
                  ...
                  <>
                    ...
                    <span className="text-slate-700 font-medium">Upload new Excel file</span>
                  </>
                )}
              </div>
            </div>
                ...
                {Loading ? (
                  <tr>
                    <td colSpan={columns.length || 1} className="py-10 text-center">
                      ...
                      <span className="text-blue-600 font-medium">Data is loading...</span>
                    </td>
                  </tr>
          ...
          {totalRecords > 0 && (
            <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
              ...
              <div className="text-sm text-slate-600">
                Showing {startIndex + 1} to {Math.min(startIndex + pageSize, totalRecords)} of {totalRecords} results
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-3 py-2 text-sm bg-white border border-slate-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 transition-colors"
                >
